...
function novoPCCtrl(toaster, BugReportService, $scope, $timeout, $stateParams) {
...
var vm = this;
    ...
    console.log($scope.listaReports.report[$scope.user.id].email);
...
angular.module('megazord').controller('novoPCCtrl', novoPCCtrl);